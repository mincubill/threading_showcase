...
public class WebClientConfig {
    ...
    private static final int ACQUIRE_TIMEOUT = 600;
    private static final int CONNECT_TIMEOUT_MILLIS = 60000;
    private static final int READ_WRITE_TIMEOUT_SECONDS = 600;
    private static final int TIMEOUT_SECONDS = 600;
    private static final int MAX_PENDING_ACQUIRES = 500;

    private static final Iterable<String> allowedCiphers =
    ...
    WebClient webClientBuilderStage() throws SSLException {
